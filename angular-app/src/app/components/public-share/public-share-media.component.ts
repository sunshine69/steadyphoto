...
@Component({
    ...
    <div class="container mt-4">
      ...
      <!-- Loading State -->
      <div *ngIf="!mediaItem && !showError" class="text-center py-5">
          ...
          <div class="photo-detail-container">
            ...
            <div class="mt-3 d-flex justify-content-between align-items-start">
              <div>
                ...
                <p class="text-muted mb-0" *ngIf="mediaItem?.captured_at">Captured: {{ mediaItem.captured_at | date:'medium' }}</p>
              </div>
              <div class="btn-group">
        ...
        <div class="col-md-4">
          <div class="card shadow-sm sticky-top" style="top: 100px;">
            ...
            <ul class="list-group list-group-flush">
              ...
              <li class="list-group-item" *ngIf="mediaItem?.width || mediaItem?.height">
              ...
              <li class="list-group-item" *ngIf="mediaItem?.size">
